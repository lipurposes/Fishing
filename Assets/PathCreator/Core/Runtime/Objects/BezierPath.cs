...
namespace PathCreation
{
    ...
    public class BezierPath
    {
        ...
        public BezierPath(BezierPathSaveData pathData){
            controlMode = ControlMode.Automatic;
            this.points = new List<Vector3>(pathData.points);
            this.perAnchorNormalsAngle = new List<float>(pathData.perAnchorNormalsAngle);
            space = PathSpace.xyz;
            isClosed = pathData.isClosed;
            controlMode = pathData.controlMode;
            autoControlLength = pathData.autoControlLength;
            globalNormalsAngle = pathData.globalNormalsAngle;
            flipNormals = pathData.flipNormals;
        }
